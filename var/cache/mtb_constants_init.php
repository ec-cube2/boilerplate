...
/** ダウンロードモジュール保存ディレクトリ */
define('MODULE_REALDIR', ROOT_REALDIR . MODULE_DIR);
/** DBセッションの有効期限(秒) */
...
/** 標準ログファイル */
define('LOG_REALFILE', LOG_REALDIR . "site.log");
/** 会員ログイン ログファイル */
define('CUSTOMER_LOG_REALFILE', LOG_REALDIR . "customer.log");
/** 管理機能ログファイル */
define('ADMIN_LOG_REALFILE', LOG_REALDIR . "admin.log");
/** デバッグログファイル(未入力:標準ログファイル・管理画面ログファイル) */
define('DEBUG_LOG_REALFILE', "");
/** エラーログファイル(未入力:標準ログファイル・管理画面ログファイル) */
define('ERROR_LOG_REALFILE', LOG_REALDIR . "error.log");
/** DBログファイル */
define('DB_LOG_REALFILE', LOG_REALDIR . "db.log");
/** プラグインログファイル */
define('PLUGIN_LOG_REALFILE', LOG_REALDIR . "plugin.log");
/** 画像一時保存 */
...
/** エンコードCSVの一時保存先 */
define('CSV_TEMP_REALDIR', ROOT_REALDIR . "temp/csv/");
/** 画像がない場合に表示 */
...
/** SMARTYテンプレート */
define('SMARTY_TEMPLATES_REALDIR',  ROOT_REALDIR . "templates/");
/** SMARTYテンプレート(PC) */
...
/** SMARTYコンパイル */
define('COMPILE_REALDIR', ROOT_REALDIR . "var/cache/smarty/" . TEMPLATE_NAME . "/");
/** SMARTYコンパイル(管理機能) */
define('COMPILE_ADMIN_REALDIR', ROOT_REALDIR . "var/cache/smarty/admin/");
/** ブロックファイル保存先 */
define('BLOC_DIR', "frontparts/bloc/");
/** SMARTYテンプレート(mobile) */
define('MOBILE_TEMPLATE_REALDIR', SMARTY_TEMPLATES_REALDIR . MOBILE_TEMPLATE_NAME . "/");
/** SMARTYコンパイル(mobile) */
define('MOBILE_COMPILE_REALDIR', ROOT_REALDIR . "var/cache/smarty/" . MOBILE_TEMPLATE_NAME . "/");
...
define('SMARTPHONE_COMPILE_REALDIR', ROOT_REALDIR . "var/cache/smarty/" . SMARTPHONE_TEMPLATE_NAME . "/");
...
/** オーナーズストアログパス */
define('OSTORE_LOG_REALFILE', LOG_REALDIR . "ownersstore.log");
/** お気に入り商品登録(有効:1 無効:0) */
...
/** プラグイン保存先ディレクトリ */
define('PLUGIN_UPLOAD_REALDIR', ROOT_REALDIR . "plugin/");
/** プラグイン保存先ディレクトリ(html) */
...
define('DOWNLOADS_TEMP_PLUGIN_UPDATE_DIR', ROOT_REALDIR . "var/temp/plugin_update/");
/** プラグイン一時展開用ディレクトリ（インストール用） */
define('DOWNLOADS_TEMP_PLUGIN_INSTALL_DIR', ROOT_REALDIR . "var/temp/plugin_install/");
/** プラグインURL */
...
/** ダウンロードファイル一時保存 */
define('DOWN_TEMP_REALDIR', ROOT_REALDIR . "var/temp/download/");
/** ダウンロードファイル保存先 */
define('DOWN_SAVE_REALDIR', ROOT_REALDIR . "var/download/");
